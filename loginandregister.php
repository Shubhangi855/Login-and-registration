...
<head>
    <meta charset="UTF-8">
    <title>Connecting Login and Registration Form to Database----</title>
...
<body>
    <div class="full-page">
        <div class='navbar'>
            ...
            <nav>
                <ul id='MenuItems'>
                    ...
                    <li><button class='loginbtn'onclick="document.getElementById('About-form').style.display='block'" style="width:auto;">About</button></li>
                </ul>
            </nav>
        </div>
        <div class="sub-page">
        ...
        <div id='About-form' class="About-page">
            <div class="form-box2">
               <span onclick="document.getElementById('About-form').style.display='none'" class="close">&times;</span>
                <div class="form2">
                    <form class='About-form', action="about.php", method="post">
                        <center><h1 class="main-heading">About us</h1></center>
                            <p>This website is designed by Shubhangi for making your life easy.<br>For any query contact us at shubhangi@gmail.com</p>
                    </form>
                </div>
            </div>
        </div>
